...
export function CTASection() {
  ...
  return (
    <section className="py-28 bg-gradient-to-br from-[#0a1628] via-[#0f2847] to-[#0a1628] relative overflow-hidden">
      ...
      <div ref={ref} className={`relative z-10 mx-auto max-w-4xl px-6 text-center transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <Button
            size="lg"
            className="bg-gradient-to-r from-[#2563eb] to-[#06b6d4] hover:from-[#1d4ed8] hover:to-[#0891b2] text-white border-0 rounded-full px-10 py-7 text-base font-semibold shadow-xl shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-300 hover:-translate-y-0.5"
          >
            Start Free Trial
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-white/15 text-white hover:bg-white/10 rounded-full px-10 py-7 text-base font-semibold bg-transparent hover:border-white/25 transition-all duration-300"
          >
            Book Demo
          </Button>
        </div>
