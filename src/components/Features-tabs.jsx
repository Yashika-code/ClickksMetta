  ...
  return (
    <section className="py-28 bg-gradient-to-b from-[#050b16] via-[#050b16] to-[#020617] relative" id="features">
      <div ref={ref} className="mx-auto max-w-7xl px-6">
        ...
        {/* Tab content */}
        <div className={`grid lg:grid-cols-2 gap-14 items-start transition-all duration-700 delay-200 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div key={activeTab} className="animate-fade-in-up">
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2 mt-8 px-6 py-3 rounded-full bg-[#0a1628] text-white text-sm font-medium hover:bg-[#0a1628]/90 transition-colors group"
            >
          ...
          {/* Visual preview card */}
          <div key={`preview-${activeTab}`} className="animate-slide-in-right">
            <div className="bg-gradient-to-br from-[#0a1628] to-[#0f2847] rounded-2xl p-8 shadow-2xl shadow-[#0a1628]/20 border border-white/5 relative overflow-hidden">
              {/* Subtle glow */}
